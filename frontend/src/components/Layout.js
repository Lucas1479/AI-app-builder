...
const Layout = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'AI Builder', href: '/builder', icon: SparklesIcon },
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="md:hidden">
              <button
                ...
                className="p-2 rounded-md text-gray-500 hover:text-gray-700 focus:outline-none focus:ring-2 focus:ring-primary-200"
              >
              ...
              return (
                <Link
                  ...
                  className={`flex items-center text-sm font-medium px-2 py-2 rounded-md ${
                    isActive ? 'text-primary-600 bg-primary-50' : 'text-gray-600 hover:text-gray-800 hover:bg-gray-50'
                  }`}
                >
                  <item.icon className="w-4 h-4 mr-2" />
                  {item.name}
